...
function scene:create (event)
	...
	local titulo = display.newImageRect (sceneGroup, "imagens/title.png", 400, 80)
	titulo.x = display.contentCenterX
	titulo.y = 200
	

	local play = display.newText (sceneGroup, "Jogar", display.contentCenterX, 700, native.systemFont, 44)
