...
-- density == densidade (acima de 1 bóia, abaixo de 1 afunda)
...
-- cria um sistema de partículas para a água
...
-- aplica um filtro sobel para retratar a superficie visível da água
...
heroi:toFront()
-- invalida o snapshot em cada frame
