...
-- subir o áudio do feitiço (tiro)            
            local audioTiro = audio.loadSound ("Audios/feitico.mp3")
...
-- Desafio 04/07
-- Adicionar áudio bg de forma agradável (nem muito alto, nem muito baixo) e adicionar áudio do feitiço para tocar ao colidir projétil do inimigo com o player

-- Áudio de fundo
local bgAudio = audio.loadStream ("Audios/bg.mp3")
audio.reserveChannels (1)
audio.setVolume (0.6, {channel=1})
audio.play (bgAudio, {channel=1, loops=-1})

-- o áudio do tiro (feitiço tá no onCollision quando o player acerta o inimigo)