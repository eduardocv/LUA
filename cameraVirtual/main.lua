...
camera:add (bg, 8) -- Adiciona a image, ao Layer especifico
...
-- as posiçoes das virgulas representam os numeros dos layers
            -- layers (1,2,3,4,5,6,7,8)
camera:setParallax (1, 0.9,0.8, 0.7, 0.6, 0.5, 0.1, 0)

camera.damping = 10 -- controla a fluidez da camera ao seguir player.
camera:setFocus (player) -- define que o player e o foco da camera.
camera:track() -- inicia a perseguicao da camera